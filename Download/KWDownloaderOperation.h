...
@interface KWDownloaderOperation : NSOperation <KWOperation>
...
/**
 * The KWDownloaderOptions for the receiver.
 * <br />下载选项
 */
@property (assign, nonatomic, readonly) KWDownloaderOptions options;

/**
 *  Initializes a `KWDownloaderOperation` object
 *  <br />初始化一个 `KWDownloaderOperation` 对象
 *
 *  @see KWDownloaderOperation
 *
